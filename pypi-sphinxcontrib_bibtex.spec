...
Source0  : https://files.pythonhosted.org/packages/83/0b/318f862d69102e6c412fd4f0a78daa271616092aa02de296e9110bc67832/sphinxcontrib-bibtex-2.6.2.tar.gz
...
%prep
%setup -q -n sphinxcontrib-bibtex-2.6.2
cd %{_builddir}/sphinxcontrib-bibtex-2.6.2
pushd ..
cp -a sphinxcontrib-bibtex-2.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704903027
